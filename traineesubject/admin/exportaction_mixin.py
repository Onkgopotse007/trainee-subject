...
class ExportActionMixin:
    def export_as_csv(self, request, queryset):
        ...
        if queryset and getattr(queryset[0], 'subject_visit', None):
        ...
        for obj in queryset:
            ...
            if getattr(obj, 'subject_visit', None):
                ...
                data.append(obj.subject_visit.visit_code)
            ...
            for field in self.get_model_fields:
                ...
                #breakpoint()
                if (field.name == 'consent_version') or self.is_visit(obj):
    ...
    def get_consent_version(self, obj=None):
        """Returns a consent version.
        """
        consent_version = getattr(obj, 'consent_version')
    ...
    def on_study(self, subject_identifier):
        caregiver_offstudy_cls = django_apps.get_model('trainee_prn.subjectoffstudy')
